const gagMaintenanceNotices = [
  ...
  "Ahavah is on a coffee break. If it takes longer than 15 minutes, it’s probably gone for a second cup. Brew with us?",
  "Be right back! We’re currently teaching our servers to sing. If you don’t hear a chorus in 15 minutes, send sheet music.",
  "We sent Ahavah on a quest for the ultimate update. If it’s not back in 15 minutes, it might be fighting a dragon. Cheer us on!",
  ...
  "We told Ahavah to take a power nap. If it’s snoring for more than 15 minutes, nudge us gently!",
  "We threw Ahavah a surprise party. If it’s still surprised in 15 minutes, bring cake!",
